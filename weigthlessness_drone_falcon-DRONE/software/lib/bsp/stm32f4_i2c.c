...
HAL_StatusTypeDef I2C_Init(I2C_TypeDef* I2Cx, uint32_t clockSpeed)
{
	...
	if(id == I2C1_ID)
	{
		...
		__HAL_RCC_GPIOB_CLK_ENABLE();
			...
			BSP_GPIO_PinCfg(GPIOB, GPIO_PIN_8, GPIO_MODE_AF_OD, GPIO_PULLUP, GPIO_SPEED_FAST, GPIO_AF4_I2C1);
			BSP_GPIO_PinCfg(GPIOB, GPIO_PIN_9, GPIO_MODE_AF_OD, GPIO_PULLUP, GPIO_SPEED_FAST, GPIO_AF4_I2C1);
		#endif
	}
	else
	{
		...
		BSP_GPIO_PinCfg(GPIOB, GPIO_PIN_10, GPIO_MODE_AF_OD, GPIO_PULLUP, GPIO_SPEED_FAST, GPIO_AF4_I2C2);
		BSP_GPIO_PinCfg(GPIOB, GPIO_PIN_11, GPIO_MODE_AF_OD, GPIO_PULLUP, GPIO_SPEED_FAST, GPIO_AF4_I2C2);
	}
 ...
 * @retval Data from slave
 */
HAL_StatusTypeDef I2C_Read_reg16(I2C_TypeDef* I2Cx, uint8_t address, uint16_t reg, uint8_t * received_data)
{
	assert(I2Cx == I2C1 || I2Cx == I2C2);
	I2C_ID_e id = ((I2Cx == I2C2)?I2C2_ID:I2C1_ID);
 ...
 * @retval None
 */
HAL_StatusTypeDef I2C_Write_reg16(I2C_TypeDef* I2Cx, uint8_t address, uint16_t reg, uint8_t data)
{
	assert(I2Cx == I2C1 || I2Cx == I2C2);
	I2C_ID_e id = ((I2Cx == I2C2)?I2C2_ID:I2C1_ID);

	return HAL_I2C_Mem_Write(&hi2c[id],address,reg,I2C_MEMADD_SIZE_16BIT,&data,1,I2C_TIMEOUT);
}
